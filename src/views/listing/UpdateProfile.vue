            ...
            <div class="col-12 col-md-10 offset-md-1">
              <div class="container">
                ...
                <div class="card rounded-0 widget--borderless w3-shadow-small text-left d-flex flex-row">
                  <div class="card-body">
                    <button type="button" name="button" class="btn btn-primary w3-light-grey font-weight-medium rounded-0 text-uppercase mr-4" data-toggle="modal" data-target="#updateProfileModal">Save</button>
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel">Update profile confirmation</h5>
          ...
          <div class="modal-footer">
            ...
            <button type="button" class="btn w3-light-grey font-weight-medium" @click="onUpdateProfile">Confirm</button>
          </div>
        </div>
      </div>
    </div>
...
export default {
  ...
  computed: {
    ...mapGetters(['loading', 'error', 'user', 'profiles', 'offices']),
    thisProfile() {
      return this.$store.getters.profile(this.id)
    }
  },
  watch: {
    thisProfile(value) {
      if (value) {
        ...
        this.general = {
          ...
          middlename: value.general.middlename,
          honorary: value.general.honorary,
          company: value.general.company,
          office: value.general.office,
          title: value.general.title,
          position: value.general.position,
          email: value.general.email,
          website: value.general.website,
          fee_price: value.general.fee_price,
          fee_currency: value.general.fee_currency,
          overview: value.general.overview,
          yearJoined: value.general.yearJoined,
        };
        this.address = {
        ...
        this.career = {
          barAdmissions: value.career.barAdmissions,
          education: value.career.education,
          professionalExperiences: value.career.professionalExperiences,
        };
  ...
  methods: {
    onUpdateProfile() {
      ...
      this.$store.dispatch('updateListingProfile', data);
      //
  ...
  created() {
    ...
    this.imageUrl = this.thisProfile.avatar;

    this.general = {
      firstname: this.thisProfile.general.firstname,
      lastname: this.thisProfile.general.lastname,
      middlename: this.thisProfile.general.middlename,
      honorary: this.thisProfile.general.honorary,
      company: this.thisProfile.general.company,
      office: this.thisProfile.general.office,
      title: this.thisProfile.general.title,
      position: this.thisProfile.general.position,
      email: this.thisProfile.general.email,
      website: this.thisProfile.general.website,
      fee_price: this.thisProfile.general.fee_price,
      fee_currency: this.thisProfile.general.fee_currency,
      overview: this.thisProfile.general.overview,
      yearJoined: this.thisProfile.general.yearJoined,
    };
    this.address = {
      country: this.thisProfile.address.country,
      city: this.thisProfile.address.city,
      zip: this.thisProfile.address.zip,
      streetAddress: this.thisProfile.address.streetAddress,
      phone: this.thisProfile.address.phone,
      free_phone: this.thisProfile.address.free_phone,
      vat_number: this.thisProfile.address.vat_number,
    };
    this.useful = {
      languages: this.thisProfile.useful.languages,
      free_consulation: this.thisProfile.useful.free_consulation,
      contingencyFee: this.thisProfile.useful.contingencyFee,
      creditCardAccepted: this.thisProfile.useful.creditCardAccepted,
    };
    this.career = {
      barAdmissions: this.thisProfile.career.barAdmissions,
      education: this.thisProfile.career.education,
      professionalExperiences: this.thisProfile.career.professionalExperiences,
    };
    this.areaOfPractices = {
      practice: this.thisProfile.areaOfPractices.practice,
      areaOfPractices: this.thisProfile.areaOfPractices.areaOfPractices,
      additionalPracticeAreas: this.thisProfile.areaOfPractices.additionalPracticeAreas,
    };
    this.socials = {
      facebook: this.thisProfile.socials.facebook,
      googleplus: this.thisProfile.socials.googleplus,
      twitter: this.thisProfile.socials.twitter,
      youtube: this.thisProfile.socials.youtube,
    };
  }
}
</script>

<template lang="html">
  <div>
      ...
      <transition name="slide" appear mode="out-in">
        <MainTile>
          <div class="widget--listing-1 w3-padding-48 px-md-5 w3-container">
            <div class="container">
              <h2 class="my-0"><strong>Update Office</strong></h2>
            </div>
          </div>
            ...
            <div class="col-12 col-md-10 offset-md-1">
              <div class="container">
                ...
                <div class="card rounded-0 widget--borderless w3-shadow-small text-left d-flex flex-row">
                  <div class="card-body">
                    <button type="button" name="button" class="btn btn-primary w3-light-grey font-weight-medium rounded-0 text-uppercase mr-4" data-toggle="modal" data-target="#updateOfficeModal">Save</button>
    ...
    <!-- Modal -->
    <div class="modal fade" id="updateOfficeModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel">Update office confirmation</h5>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
              <span aria-hidden="true">&times;</span>
            </button>
          </div>
          <div class="modal-body">
            Do you want to update this office ?
          </div>
          <div class="modal-footer">
            <button type="button" class="btn w3-light-grey font-weight-medium" data-dismiss="modal">Close</button>
            <button type="button" class="btn w3-light-grey font-weight-medium" @click="onUpdateOffice">Confirm</button>
          </div>
        </div>
      </div>
    </div>
...
export default {
  ...
  computed: {
    ...
    thisOffice() {
      return this.$store.getters.office(this.id)
    }
  },
  watch: {
    thisOffice(value) {
      if (value) {
        ...
        this.general = {
          status: value.general.status,
          title: value.general.title,
          email: value.general.email,
          website: value.general.website,
          officeOpen: value.general.officeOpen,
          officeClose: value.general.officeClose,
          honorary_price: value.general.honorary_price,
          honorary_currency: value.general.honorary_currency,
          overview: value.general.overview,
        };
        this.address = {
          ...
          free_phone: value.address.free_phone,
          vat_number: value.address.vat_number,
        };
        this.office = {
          yearFounded: value.office.yearFounded,
          officeNumbers: value.office.officeNumbers,
          lawyerNumbersAtOffice: value.office.lawyerNumbersAtOffice,
          lawyerNumbersAllOffices: value.office.lawyerNumbersAllOffices,
        };
        this.useful = {
          languages: value.useful.languages,
          free_consulation: value.useful.free_consulation,
          contingencyFee: value.useful.contingencyFee,
          creditCardAccepted: value.useful.creditCardAccepted,
        };
        this.areaOfPractices = {
          practice: value.areaOfPractices.practice,
          areaOfPractices: value.areaOfPractices.areaOfPractices,
          additionalPracticeAreas: value.areaOfPractices.additionalPracticeAreas,
        };
        this.socials = {
          facebook: value.socials.facebook,
          googleplus: value.socials.googleplus,
  ...
  methods: {
    onUpdateOffice() {
      ...
      this.$store.dispatch('updateListingOffice', data);
      //
  ...
  mounted() {
    ...
    //
    $('#country-input').val(this.thisOffice.address.country);
    $('#city-input').val(this.thisOffice.address.city);
  },
  created() {
    this.image = null;
    this.imageUrl = 'https://upload.wikimedia.org/wikipedia/commons/7/7c/Profile_avatar_placeholder_large.png';
    ...
    this.imageUrl = this.thisOffice.avatar;

    this.general = {
      status: this.thisOffice.general.status,
      title: this.thisOffice.general.title,
      email: this.thisOffice.general.email,
      website: this.thisOffice.general.website,
      officeOpen: this.thisOffice.general.officeOpen,
      officeClose: this.thisOffice.general.officeClose,
      honorary_price: this.thisOffice.general.honorary_price,
      honorary_currency: this.thisOffice.general.honorary_currency,
      overview: this.thisOffice.general.overview,
    };
    this.address = {
      country: this.thisOffice.address.country,
      city: this.thisOffice.address.city,
      zip: this.thisOffice.address.zip,
      streetAddress: this.thisOffice.address.streetAddress,
      phone: this.thisOffice.address.phone,
      free_phone: this.thisOffice.address.free_phone,
      vat_number: this.thisOffice.address.vat_number,
    };
    this.office = {
      yearFounded: this.thisOffice.office.yearFounded,
      officeNumbers: this.thisOffice.office.officeNumbers,
      lawyerNumbersAtOffice: this.thisOffice.office.lawyerNumbersAtOffice,
      lawyerNumbersAllOffices: this.thisOffice.office.lawyerNumbersAllOffices,
    };
    this.useful = {
      languages: this.thisOffice.useful.languages,
      free_consulation: this.thisOffice.useful.free_consulation,
      contingencyFee: this.thisOffice.useful.contingencyFee,
      creditCardAccepted: this.thisOffice.useful.creditCardAccepted,
    };
    this.areaOfPractices = {
      practice: this.thisOffice.areaOfPractices.practice,
      areaOfPractices: this.thisOffice.areaOfPractices.areaOfPractices,
      additionalPracticeAreas: this.thisOffice.areaOfPractices.additionalPracticeAreas,
    };
    this.socials = {
      facebook: this.thisOffice.socials.facebook,
      googleplus: this.thisOffice.socials.googleplus,
      twitter: this.thisOffice.socials.twitter,
      youtube: this.thisOffice.socials.youtube,
    };
  }
}
</script>
